...
var db *sql.DB
var err error
var PlayerNumber = flag.Int("p", 1, "set the number of Players needed to start the Quiz")
var QuestionPerRound = flag.Int("q", 3, "set the number of Questions per round")
